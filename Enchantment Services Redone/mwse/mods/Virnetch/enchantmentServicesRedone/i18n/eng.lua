...
--	["service.transcription.mainMenu.costLabel"] = "Cost",
	...
	["mcm.service.deciphering.customName.label"] = "Allow custom name",
	["mcm.service.deciphering.customName.description"] = "Adds an additional menu before deciphering a scroll with the option to change the created spell's name."
		...
		.. "\n - Only when necessary and a custom scroll: Same as the above, but only for scrolls created by the player. This option might prevent the player from deciphering some scrolls, such as possible mod added special quest items."
		.. "\n - Never: The menu will never be shown. Note that this will prevent the player from deciphering scrolls for which a name can't automatically be generated, possibly including custom enchanted scrolls and mod added special quest items."
		.. "\n\nDefault: Only when necessary and a custom scroll"
		.. "\n\nIf playing a localized version of the game without a proper translation of this mod, it's recommended to set this option to 'Only when necessary', otherwise the option 'Only when necessary and a custom scroll' is recommended.",
	["mcm.service.deciphering.customName.options.always"] = "Always",
	["mcm.service.deciphering.customName.options.onlyIfBad"] = "Only when necessary",
	["mcm.service.deciphering.customName.options.onlyIfBadAndCustom"] = "Only when necessary and a custom scroll",
	["mcm.service.deciphering.customName.options.never"] = "Never",
